...
Purpose: Support executive decisions (pricing, mix, territories, sellers) with policy controls and auditable KPIs.

KPIs: profit YoY/MoM/YTD; exception rate; revenue volatility; RFM; bundle lift.

Controls: orphan keys=0; 'Unknowns' under threshold; |z|<2 unless approved events.

Data Quality: null/outlier handling; timestamps; time windows.
